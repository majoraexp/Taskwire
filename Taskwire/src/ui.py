...
from PyQt6.QtCore import Qt, QRectF, QSize, QPointF, QPoint, QEvent, QTimer
...
class ServicesWidget(QWidget):
    ...
    def _update_button_state(self):
        ...
        has_sel = unit is not None
        self.btn_start.setEnabled(has_sel)
        self.btn_stop.setEnabled(has_sel)
        self.btn_restart.setEnabled(has_sel)
